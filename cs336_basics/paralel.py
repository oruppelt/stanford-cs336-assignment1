...
def run_train_bpe_parallel(input_path: str, vocab_size: int, special_tokens: list[str], num_processes: int | None = None):
...
# 3) Serialize (bytes-safe via latin1 round-trip)
    out_dir = "../artifacts/owt_valid"
